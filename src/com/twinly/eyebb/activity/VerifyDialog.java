...
public class VerifyDialog extends Activity {
	...
	private void postDeviceToChildToServer() {
		...
		map.put("childId", SharePrefsUtils.signUpChildId(VerifyDialog.this));
		map.put("macAddress", SharePrefsUtils.isMacAddress(VerifyDialog.this));
		map.put("major", SharePrefsUtils.signUpDeviceMajor(VerifyDialog.this));
		map.put("minor", SharePrefsUtils.signUpDeviceMinor(VerifyDialog.this));
		System.out.println("postDeviceToChildToServer=>"
				+ SharePrefsUtils.signUpChildId(VerifyDialog.this) + " "
				+ SharePrefsUtils.isMacAddress(VerifyDialog.this) + " "
				+ SharePrefsUtils.signUpDeviceMajor(VerifyDialog.this) + " "
				+ SharePrefsUtils.signUpDeviceMinor(VerifyDialog.this));
		...
		try {
			...
			if (retStr.equals(HttpConstants.HTTP_POST_RESPONSE_EXCEPTION)
				...
				if (retStr.equals("true")) {
					...
					Intent intent = new Intent(VerifyDialog.this,
							LancherActivity.class);
					// use to login
					SharePrefsUtils.setLogin(VerifyDialog.this, true);
					SharePrefsUtils.setLoginAccount(VerifyDialog.this,
							SharePrefsUtils.signUpUsername(VerifyDialog.this));
					SharePrefsUtils.setPassowrd(VerifyDialog.this,
							SharePrefsUtils.signUpPassword(VerifyDialog.this));
					...
					SharePrefsUtils.setSignUpDeviceMajor(VerifyDialog.this,
							major);
					SharePrefsUtils.setSignUpDeviceMinor(VerifyDialog.this,
							minor);
