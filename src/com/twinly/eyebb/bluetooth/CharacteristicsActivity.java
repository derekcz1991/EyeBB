...
public class CharacteristicsActivity extends Activity {
			...
			if (BluetoothLeService.ACTION_DATA_AVAILABLE.equals(action)) {
				...
				if (uuid.equals("2a19")) {
					...
					Toast.makeText(
							...
							"Battery level :" + Integer.parseInt(data, 16)
									+ "%", Toast.LENGTH_LONG).show();
				} else if (uuid.equals("2a05")) {
					System.out.println("this is 2a05" + data + "=>16/ "
							+ Integer.parseInt(data, 16));
					Toast.makeText(CharacteristicsActivity.this,
							"2a05:" + Integer.parseInt(data, 16),
							Toast.LENGTH_LONG).show();
				} else if (uuid.equals("ffe1")) {
					System.out.println("this is ffe1" + data + "=>16/ "
							+ Integer.parseInt(data, 16));
				}
			}
		}
	...
	// View layout =
	// inflater.inflate(R.layout.ffb0,(ViewGroup)findViewById(R.id.ffb0_dialog));
	//
	// AlertDialog.Builder builder = new
	// AlertDialog.Builder(CharacteristicsActivity.this);
	...
	// if(key1_value < 100000 || key1_value > 999999 || key2_value < 100000 ||
	// key2_value > 999999){
	// Toast.makeText(CharacteristicsActivity.this,
	// "The key must be 100000-999999",Toast.LENGTH_LONG).show();
	// }else if(key1_value != key2_value){
	// Toast.makeText(CharacteristicsActivity.this,
	// "Input different",Toast.LENGTH_LONG).show();
	// }else{
	// flag = true;
	...
	// try {//下面三句控制弹框的关闭
	// Field field =
	// arg0.getClass().getSuperclass().getDeclaredField("mShowing");
	...
	// LayoutInflater inflater = getLayoutInflater();
	// View layout =
	// inflater.inflate(R.layout.ffb1,(ViewGroup)findViewById(R.id.ffb1_dialog));
	//
	// AlertDialog.Builder builder = new
	// AlertDialog.Builder(CharacteristicsActivity.this);
	// builder.setView(layout);
	...
	// Toast.makeText(CharacteristicsActivity.this,
	// "MajorID or MinorID must be 0-65535",Toast.LENGTH_LONG).show();
	// }else{
	// flag = true;
	...
	// LayoutInflater inflater = getLayoutInflater();
	// View layout =
	// inflater.inflate(R.layout.ffb2,(ViewGroup)findViewById(R.id.ffb2_dialog));
	//
	// AlertDialog.Builder builder = new
	// AlertDialog.Builder(CharacteristicsActivity.this);
	// builder.setView(layout);
	...
	// if(u1.length() != 8 || u2.length() != 4 || u3.length() != 4 ||
	// u4.length() != 4 || u5.length() != 12){
	// Toast.makeText(CharacteristicsActivity.this,
	// "UUID's size error",Toast.LENGTH_LONG).show();
	// }else{
	// flag = true;
	...
	// LayoutInflater inflater = getLayoutInflater();
	// View layout =
	// inflater.inflate(R.layout.ffb3,(ViewGroup)findViewById(R.id.ffb3_dialog));
	//
	// AlertDialog.Builder builder = new
	// AlertDialog.Builder(CharacteristicsActivity.this);
	// builder.setView(layout);
	...
	// if(sec < 1 || sec > 100){
	// Toast.makeText(CharacteristicsActivity.this,
	// "The value must be 1-100",Toast.LENGTH_LONG).show();
	// }else{
	// flag = true;
	...
	// LayoutInflater inflater = getLayoutInflater();
	// View layout =
	// inflater.inflate(R.layout.ffb4,(ViewGroup)findViewById(R.id.ffb4_dialog));
	//
	// AlertDialog.Builder builder = new
	// AlertDialog.Builder(CharacteristicsActivity.this);
	// builder.setView(layout);
	...
	// Toast.makeText(CharacteristicsActivity.this,
	// "The string length must be 1-15",Toast.LENGTH_LONG).show();
	// }else{
	// flag = true;
	// editstr = editstr + "#";
	// BluetoothGattCharacteristic characteristic = charas.get(charaidx);
	...
	// LayoutInflater inflater = getLayoutInflater();
	// View layout =
	// inflater.inflate(R.layout.ffb5,(ViewGroup)findViewById(R.id.ffb5_dialog));
	//
	// AlertDialog.Builder builder = new
	// AlertDialog.Builder(CharacteristicsActivity.this);
	// builder.setView(layout);
	...
	// System.out.println("data==========>" + data);
	// int x = Integer.parseInt(data.substring(0,2),16) +
	// Integer.parseInt(data.substring(2,4),16)*256;
	// int y = Integer.parseInt(data.substring(4,6),16) +
	// Integer.parseInt(data.substring(6,8),16)*256;
	// int z = Integer.parseInt(data.substring(8,10),16) +
	// Integer.parseInt(data.substring(10,12),16)*256;
	// int gx = Integer.parseInt(data.substring(16,18),16) +
	// Integer.parseInt(data.substring(18,20),16)*256;
	// int gy = Integer.parseInt(data.substring(20,22),16) +
	// Integer.parseInt(data.substring(22,24),16)*256;
	// int gz = Integer.parseInt(data.substring(24,26),16) +
	// Integer.parseInt(data.substring(26,28),16)*256;
	// if(x >= 0x8000){
	// x = x - 0x10000;
	// }
	// if(y >= 0x8000){
	...
	// }
	// Toast.makeText(CharacteristicsActivity.this,
	// "x: "+x+" y: "+y+" z: "+z+" gx: "+gx+" gy: "+gy+" gz: "+gz,Toast.LENGTH_LONG).show();
	// }
	// private void getFFB7(String data){
	// System.out.println("data==========>" + data);
	// int temperature = Integer.parseInt(data.substring(0,2),16) +
	// Integer.parseInt(data.substring(2,4),16)*0x100 +
	// Integer.parseInt(data.substring(4,6),16)*0x10000 +
	// Integer.parseInt(data.substring(6,8),16)*0x1000000;
	// int pressure = Integer.parseInt(data.substring(8,10),16) +
	// Integer.parseInt(data.substring(10,12),16)*0x100 +
	// Integer.parseInt(data.substring(12,14),16)*0x10000 +
	// Integer.parseInt(data.substring(14,16),16)*0x1000000;
	// float ftemp = (float)(temperature / 10.0);
	// Toast.makeText(CharacteristicsActivity.this,
	// "Temp: "+ftemp+"  Pressure: "+pressure,Toast.LENGTH_LONG).show();
	// }
	// private void modifyFFB8(String data){
	// LayoutInflater inflater = getLayoutInflater();
	// View layout =
	// inflater.inflate(R.layout.ffb8,(ViewGroup)findViewById(R.id.ffb8_dialog));
	//
	// AlertDialog.Builder builder = new
	// AlertDialog.Builder(CharacteristicsActivity.this);
	// builder.setView(layout);
	...
	// if(tp > 0 || tp < -100){
	// Toast.makeText(CharacteristicsActivity.this,
	// "The value must be -1db ~ -100db",Toast.LENGTH_LONG).show();
	// }else{
	// flag = true;
	// byte[] data = new byte[1];
	// if(tp < 0){
